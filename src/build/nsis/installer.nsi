...
!define BITNESS "32"
!define ARCH_TAG ""
!define INSTALLER_NAME "My_App_1.0.exe"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "My App"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\My App.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\My_App.launch.pyw"' "$INSTDIR\glossyorb.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    ...
    Delete "$INSTDIR\My_App.launch.pyw"
